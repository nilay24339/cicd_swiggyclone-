    ...
    <div className="d-flex flex-column justify-content-center align-items-center w-100">
      ...
      >
        <div className="w-75 d-flex justify-content-center align-items-center pt-3 pb-3">
          <h3 style={{ letterSpacing: "-.5px", fontWeight: 900, color: "#41444a" }}>
            For better experience,download <br /> the Swiggy app now
          </h3>

          {/* FIXED: completed URL + closed img tag (kept same location/source) */}
          <img
            className="img-fluid"
            width={"180px"}
            style={{ height: "60px", marginLeft: "90px", marginRight: "30px" }}
      ...
      <div
        ...
        className="d-flex justify-content-center align-tems-center w-100"
      >
        <div className="w-75 d-flex justify-content-around pt-5 pb-5">
          <div>
            <div className="d-flex align-items-center">
              <img width={"30px"} src={logo} alt="Logo" />
              <h3 style={{ color: "white" }} className="fw-bolder mt-1 ms-2">
                Swiggy
              </h3>
            </div>
          ...
          <div style={{ color: "#9e9e9e" }}>
            ...
            {/* FIXED: close button + valid i tag */}
            <button
              style={{
                padding: "10px",
            ...
            >
              589 cities <i className="ms-2" aria-hidden="true">▼</i>
            </button>
          </div>
        </div>
      </div>
